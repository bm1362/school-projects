(function( $ ){
	...
	$.fn.slider = function( options ) {
	    ...
	    function initialize() {
			...
			rightBound = offset + ((settings.width + settings.guideWidth)/2) - settings.knobWidth/2 + 2 * settings.boundWidth - 1;
			...
			$knob.css("position", "absolute").css("top",  (baseHeight - settings.knobHeight/2) + "px").css("left", knobStart + "px").css('z-index', 1000)
			...
			$knobWrapper.css("position", "absolute").css("padding", "15px").css("left", "-15px").css("top", "-15px")


			$el.on(cursorDownEvent, onCursorDown)
